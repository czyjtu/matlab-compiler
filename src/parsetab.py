...
_lr_productions = [
  ...
  ('expr_stmt -> expr SEMI','expr_stmt',2,'p_expr_stmt','my_parser.py',65),
  ('function_stmt -> FUNCTION ID EQ function_declr stmt_list END','function_stmt',6,'p_function_stmt','my_parser.py',72),
  ('function_declr -> ID LPAREN args_opt RPAREN','function_declr',4,'p_function_declr','my_parser.py',78),
  ('args_opt -> <empty>','args_opt',0,'p_args_opt','my_parser.py',84),
  ('args_opt -> args','args_opt',1,'p_args_opt','my_parser.py',85),
  ('args -> ID','args',1,'p_args','my_parser.py',95),
  ('args -> args COMMA ID','args',3,'p_args','my_parser.py',96),
  ('stmt_list_opt -> <empty>','stmt_list_opt',0,'p_stmt_list_opt','my_parser.py',105),
  ('stmt_list_opt -> stmt_list','stmt_list_opt',1,'p_stmt_list_opt','my_parser.py',106),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens_expr','my_parser.py',116),
  ('expr -> function_call','expr',1,'p_expr','my_parser.py',123),
  ('expr -> ID','expr',1,'p_expr','my_parser.py',124),
  ('expr -> NUMBER','expr',1,'p_expr','my_parser.py',125),
  ('expr -> STRING','expr',1,'p_expr','my_parser.py',126),
  ('expr -> expr1','expr',1,'p_expr','my_parser.py',127),
  ('expr -> expr2','expr',1,'p_expr','my_parser.py',128),
  ('function_call -> ID LPAREN expr_list_opt RPAREN','function_call',4,'p_function_call','my_parser.py',134),
  ('expr_list_opt -> <empty>','expr_list_opt',0,'p_expr_args_opt','my_parser.py',140),
  ('expr_list_opt -> expr_list','expr_list_opt',1,'p_expr_args_opt','my_parser.py',141),
  ('expr_list -> expr','expr_list',1,'p_expr_args','my_parser.py',151),
  ('expr_list -> expr_list COMMA expr','expr_list',3,'p_expr_args','my_parser.py',152),
  ('expr1 -> NEG expr','expr1',2,'p_expr1','my_parser.py',161),
  ('expr2 -> expr LT expr','expr2',3,'p_expr2','my_parser.py',166),
  ('expr2 -> expr AND expr','expr2',3,'p_expr2','my_parser.py',167),
  ('expr2 -> expr DIV expr','expr2',3,'p_expr2','my_parser.py',168),
  ('expr2 -> expr POW expr','expr2',3,'p_expr2','my_parser.py',169),
  ('expr2 -> expr GE expr','expr2',3,'p_expr2','my_parser.py',170),
  ('expr2 -> expr GT expr','expr2',3,'p_expr2','my_parser.py',171),
  ('expr2 -> expr LE expr','expr2',3,'p_expr2','my_parser.py',172),
  ('expr2 -> expr MINUS expr','expr2',3,'p_expr2','my_parser.py',173),
  ('expr2 -> expr MUL expr','expr2',3,'p_expr2','my_parser.py',174),
  ('expr2 -> expr OR expr','expr2',3,'p_expr2','my_parser.py',175),
  ('expr2 -> expr PLUS expr','expr2',3,'p_expr2','my_parser.py',176),
  ('expr2 -> expr EQ expr','expr2',3,'p_expr2','my_parser.py',177),
  ('expr2 -> expr EQEQ expr','expr2',3,'p_expr2','my_parser.py',178),
  ('if_stmt -> IF expr stmt_list_opt elseif_stmt END','if_stmt',5,'p_if_stmt','my_parser.py',185),
  ('elseif_stmt -> <empty>','elseif_stmt',0,'p_elseif_stmt','my_parser.py',192),
  ('elseif_stmt -> ELSE stmt_list_opt','elseif_stmt',2,'p_elseif_stmt','my_parser.py',193),
  ('elseif_stmt -> ELSEIF expr stmt_list_opt elseif_stmt','elseif_stmt',4,'p_elseif_stmt','my_parser.py',194),
]
